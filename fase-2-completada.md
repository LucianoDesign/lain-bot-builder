...
## Fase 3 — Pendiente
- Publicar flow (snapshot + toggle isPublished)
- Runtime de ejecución del chatflow (chat widget embebible)
- Webhook node config
- AI Block node (llama a Claude API)
- Copy/paste de nodos
- Validación del flow antes de publicar
